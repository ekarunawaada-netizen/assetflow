      ...
      <main>
        ...
        <section className="max-w-[1280px] mx-auto px-6 py-16">
          {collections.length > 0 ? (
            ...
            <div className="text-center py-20 bg-surface border-4 border-on-background rounded-3xl bento-shadow">
              <span className="material-symbols-outlined text-[64px] text-outline mb-4">inventory_2</span>
              <h2 className="font-headline text-3xl font-black text-on-background mb-2">Belum ada koleksi</h2>
              <p className="font-body text-on-surface-variant">Koleksi aset premium akan segera hadir.</p>
            </div>
          )}
        </section>
      </main>
